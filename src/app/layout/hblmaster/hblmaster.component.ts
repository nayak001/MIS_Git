...
export class HblmasterComponent implements OnInit {
  ...
  public searchhblstudentsbystudentname() {
    ...
    this.hblmasterService
      .searchhblstudentsbystudentname(this.studentnamesearchstring)
      .subscribe(
        (data) => {
  ...
  getallstudentsdatabypage() {
    this.hblmasterService.getallhblstudentsbypage(this.page).subscribe(
      (data) => {
        if (data != undefined) {
  ...
  getallmanagersdata() {
    ...
    this.hblmasterService.getallhblmanagers().subscribe(
      (data) => {
  ...
  getallvolunteersdata() {
    this.hideLoading_indicator = false;
    this.hblmasterService.getallhblvolunteers().subscribe(
      (data) => {
  ...
  gethblvolunteerbyvolunteerid(volunteerid) {
    this.hideLoading_indicator = false;
    this.hblmasterService.gethblvolunteerbyvolunteerid(volunteerid).subscribe(
      (data) => {
  ...
  gethblvolunteerbymanagerid(managerid) {
    this.hideLoading_indicator = false;
    this.hblmasterService.gethblvolunteerbymanagerid(managerid).subscribe(
      (data) => {
        if (Object.keys(data).length > 0) {
  ...
  getallschoolsdata() {
    this.hideLoading_indicator = false;
    this.hblmasterService.getallhblschools().subscribe(
      (data) => {
  ...
  getalllevelsdata() {
    this.hideLoading_indicator = false;
    this.hblmasterService.getallhbllevels().subscribe(
      (data) => {
  ...
  getallresponsesdata() {
    this.hideLoading_indicator = false;
    this.hblmasterService.getallhblresponses().subscribe(
      (data) => {
  ...
  gethblschoolbyschoolid(schoolid) {
    this.hideLoading_indicator = false;
    this.hblmasterService.gethblschoolbyschoolid(schoolid).subscribe(
      (data) => {
        if (Object.keys(data).length > 0) {
  ...
  student_save_btn_click() {
    if (
      this.studentmanagerid == undefined ||
      this.studentmanagerid == null ||
      this.studentmanagerid.trim() == ""
    ) {
      swal.fire("Info", "Please select manager", "warning");
    } else if (
      this.studentvolunteerid == undefined ||
      this.studentvolunteerid == null ||
      this.studentvolunteerid.trim() == ""
    ) {
      swal.fire("Info", "Please select teacher", "warning");
    } else if (
      this.studentschoolid == undefined ||
      this.studentschoolid == null ||
      this.studentschoolid.trim() == ""
    ) {
      ...
      swal.fire(
        "Info",
        "Please enter a valid phone number. Valid formats: 0123456789, (012)345-6789, 012-345-6789",
        "warning"
      );
    } else if (
      this.studentclass == undefined ||
      ...
      this.hblmasterService.createnewhblstudent(body).subscribe(
        (data) => {
  ...
  manager_save_btn_click() {
    if (
      ...
      this.hideModalLoading_indicator = false;
      this.hblmasterService.createnewhblmanager(body).subscribe(
        (data) => {
          this.toast("success", "Successfully saved");
  ...
  volunteer_save_btn_click() {
    if (
      this.volunteermanagername == undefined ||
      this.volunteermanagername == null ||
      ...
      this.volunteerphone == undefined ||
      this.volunteerphone == null ||
      this.volunteerphone.trim() == ""
    ) {
      swal.fire("Info", "Phone number is required", "warning");
      ...
      this.hideModalLoading_indicator = false;
      this.hblmasterService.createnewhblvolunteer(body).subscribe(
        (data) => {
          this.toast("success", "Successfully saved");
  ...
  school_save_btn_click() {
    if (
      ...
      this.schooldistrict == undefined ||
      this.schooldistrict == null ||
      this.schooldistrict.trim() == ""
    ) {
      swal.fire("Info", "Please select district", "warning");
    } else if (
      this.schoolblock == undefined ||
      this.schoolblock == null ||
      this.schoolblock.trim() == ""
    ) {
      ...
      this.hideModalLoading_indicator = false;
      this.hblmasterService.createnewhblschool(body).subscribe(
        (data) => {
          this.toast("success", "Successfully saved");
  ...
  level_save_btn_click() {
    if (
      ...
      this.hideModalLoading_indicator = false;
      this.hblmasterService.createnewhbllevel(body).subscribe(
        (data) => {
          this.toast("success", "Successfully saved");
  ...
  response_save_btn_click() {
    if (
      this.responsedesc == undefined ||
      this.responsedesc == null ||
      this.responsedesc.trim() == ""
    ) {
      swal.fire("Info", "Please check response description", "warning");
    } else if (
      this.responsesubject == undefined ||
      this.responsesubject == null ||
      this.responsesubject.trim() == ""
    ) {
      swal.fire("Info", "Please select subject", "warning");
    } else {
      ...
      this.hideModalLoading_indicator = false;
      this.hblmasterService.createnewhblresponse(body).subscribe(
        (data) => {
          this.toast("success", "Successfully saved");
  ...
  student_update_btn_click() {
    if (
      ...
      this.hblmasterService.updatehblstudent(this._id, body).subscribe(
        (data) => {
          let obj = {
            managerid: this.studentmanagerid,
            managername: this.studentmanagername,
          ...
          this.hblmasterService
            .updatehbl_trnasactivity_transbaseline_bystudentid(
              this.studentid,
              obj
            )
            .subscribe(
  ...
  manager_update_btn_click() {
    if (
      ...
      this.hblmasterService.updatehblmanager(this._id, body).subscribe(
        (data) => {
          let obj = {
            managername: this.managername.toLowerCase(),
          };
          ...
          this.hblmasterService
            .updatehblvolunteer_managername(this.managerid, obj)
            .subscribe(
              (data) => {
                this.hblmasterService
                  .updatehblstudent_managername(this.managerid, obj)
                  .subscribe(
                    (data) => {
                      this.hblmasterService
                        .updatehbl_trnasactivity_transbaseline_bymanagerid(
                          this.managerid,
                          obj
                        )
                        .subscribe(
  ...
  volunteer_update_btn_click() {
    if (
      ...
      this.hblmasterService.updatehblvolunteer(this._id, body).subscribe(
        (data) => {
          let obj = {
            managerid: this.volunteermanagerid,
            managername: this.volunteermanagername,
          ...
          this.hblmasterService
            .updatehblstudent_volunteername(this.volunteerid, obj)
            .subscribe(
              (data) => {
                this.hblmasterService
                  .updatehbl_trnasactivity_transbaseline_byvolunteerid(
                    this.volunteerid,
                    obj
                  )
                  .subscribe(
  ...
  school_update_btn_click() {
    if (
      ...
      this.hblmasterService.updatehblschool(this._id, body).subscribe(
        (data) => {
          let obj = {
            schoolname: this.schoolname.toLowerCase(),
          };
          ...
          this.hblmasterService
            .updatehblstudent_schoolname(this.schoolid, obj)
            .subscribe(
              (data) => {
                this.toast("success", "Successfully updated");
  ...
  level_update_btn_click() {
    if (
      ...
      this.hblmasterService.updatehbllevel(this._id, body).subscribe(
        (data) => {
          this.toast("success", "Successfully updated");
  ...
  response_update_btn_click() {
    if (
      ...
      this.hblmasterService.updatehblresponse(this._id, body).subscribe(
        (data) => {
          this.toast("success", "Successfully updated");
  ...
  deletestudent(id) {
    this.hideLoading_indicator = false;
    this.hblmasterService.deletehblstudent(id).subscribe(
      (data) => {
  ...
  deletemanager(id) {
    if (this.is_manager_have_volunteers == true) {
      swal.fire(
        "Info",
        "Can not delete this manager because it is linked with some of the teachers. Please re-assign the teachers to another manager.",
        "info"
      );
    } else {
      this.hideLoading_indicator = false;
      this.hblmasterService.deletehblmanager(id).subscribe(
        (data) => {
          this.toast("success", "Successfully deleted");
  ...
  deletevolunteer(id, volunteerid) {
    this.hideLoading_indicator = false;
    this.hblmasterService.deletehblvolunteer(id).subscribe(
      (data) => {
        this.hblmasterService
  ...
  deleteschool(id, schoolid) {
    this.hideLoading_indicator = false;
    this.hblmasterService.deletehblschool(id).subscribe(
      (data) => {
        this.hblmasterService.deletehblstudentsbyschoolid(schoolid).subscribe(
          (data) => {
            this.toast("success", "Successfully deleted");
  ...
  deletelevel(id) {
    this.hideLoading_indicator = false;
    this.hblmasterService.deletehbllevel(id).subscribe(
      (data) => {
        this.toast("success", "Successfully deleted");
  ...
  deleteresponse(id) {
    this.hideLoading_indicator = false;
    this.hblmasterService.deletehblresponse(id).subscribe(
      (data) => {
        this.toast("success", "Successfully deleted");
  ...
  searchstudentbystudentname() {
    if (
      this.studentnamesearchstring == undefined ||
      this.studentnamesearchstring == null ||
      this.studentnamesearchstring.trim() == ""
    ) {
    } else {
  ...
  searchvolunteer(term: string) {
    ...
    if (!term) {
      ...
      this.all_volunteers_list = this.all_volunteers_list_bkp.filter(
        (element) =>
          element.volunteername
            .toLowerCase()
