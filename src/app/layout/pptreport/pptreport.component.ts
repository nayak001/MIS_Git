...
export class PptreportComponent implements OnInit {
	...
	// Language
	language_list: any = [{languageid: 'en', languagename: 'English'}, {languageid: 'od', languagename: 'Odia'}, {languageid: 'hi', languagename: 'Hindi'}];
	...
	language_multiselect_onselect(item: any) {this.showdata();} 
	language_multiselect_ondeselect(items: any) {this.showdata();}
	...
	// Show Data
	async showdata(){
		if(this.language_multiselect_selectedlist == undefined || this.language_multiselect_selectedlist == null || this.language_multiselect_selectedlist.length <= 0 ){
