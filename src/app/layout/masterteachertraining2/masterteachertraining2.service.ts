...
export class Masterteachertraining2Service {
  ...
  getalltrainingmodules(language, usertype) {
    return this.http.get(
      baseUrl + "getalltrainingmodules/" + language + "/" + usertype,
      {
        headers: new HttpHeaders().set("Content-Type", "application/json"),
        //responseType: 'text'
      }
  ...
  uploadImage(formData) {
    return this.http.post(baseUrl + "trainingcontentsuploads", formData, {
  ...
  createnewtrainingcontents(body) {
    return this.http.post(baseUrl + "createnewtrainingcontents", body, {
      headers: new HttpHeaders().set("Content-Type", "application/json"),
      //,responseType: 'text'
    });
  }
