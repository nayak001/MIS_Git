...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'offlinetraining', loadChildren: './offlinetraining/offlinetraining.module#OfflinetrainingModule' },
      ...
      { path: 'anganwadimanager', loadChildren: './anganwadimanager/anganwadimanager.module#AnganwadimanagerModule' },
