...
@Component({
    selector: 'app-centerfeedback',
    templateUrl: './centerfeedback.component.html',
    styleUrls: ['./centerfeedback.component.scss'],
    animations: [routerTransition()]
})
export class CenterfeedbackComponent implements OnInit {
