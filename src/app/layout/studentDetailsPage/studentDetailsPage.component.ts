...
import {
  StudentDetailsPageService,
  ValidationService,
} from "./studentDetailsPage.service";
...
export class StudentDetailsPageComponent implements OnInit {
  ...
  getallDetailsStudents() {
    ...
    this.StudentDetailsPageService.getallDetailsStudents(data).subscribe(
      (res) => {
  ...
  getBlockDetails() {
    this.StudentDetailsPageService.getBlocks().subscribe(
      (data) => {
  ...
  download() {
    ...
    const rows = [
      [
        ...
        "Odia Assessment Score",
        "Quarterly ECE Assessment Score",
        "Avg Attendance	",
        "No of Endline Assessment Completed in PG	",
        "No of Levels jumped in Maths",
        "No of Levels jumped in Odia",
        "No of Levels jumped in English",
        "Total Number of Quarter 4 Assessment Completed in ECE",
        "Acheived atleast 70% age-appropriate learning outcomes in ECE",
        "Baseline Test Participated",
      ...
      (res) => {
        ...
        this.getallStu.forEach((value) => {
          ...
          var array = [
            ...
            value.student.user ? value.student.user.centername : "",
            value.student.user ? value.student.user.centerid : "",
            value.student.user ? value.student.user.usertype : "",
            usertType,
            value.student.program,
            value.student.user.block,
            value.student.user.districtvalue || "",
            value.state,
            value.student.ec_level,
            value.student.math_level,
            value.student.eng_level,
            value.student.odia_level,
            math_String,
            eng_String || "",
            odia_String || "",
            ece_string || "",
            value.avg_attendancce + "%" || "0%",
            endline || "",
            value.jumpmath,
            value.jumpodia,
            value.jumpeng,
