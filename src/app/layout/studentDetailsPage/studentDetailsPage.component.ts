...
export class StudentDetailsPageComponent implements OnInit {
	...
	download(){
		...
		this.loader = true;
		const rows =[["Name", "Date of Enrollment","Sex","Center Name","Centerid","Center Type","Name of the Type", "Program Type", 
						"Block","District","State","ECE Level", "PG Maths Level", "PG English Level", "PG Odia Level",
						"Maths Assessment Score","English Assessment Score","Odia Assessment Score","Quarterly ECE Assessment Score",
						"Avg Attendance	","No of Endline Assessment Completed in PG	", "No of Levels jumped in Maths", 
						"No of Levels jumped in Odia","No of Levels jumped in English",
