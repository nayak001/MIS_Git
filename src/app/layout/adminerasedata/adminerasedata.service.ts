...
export class AdminEraseDataService {
  ...
  savemasterpostcallactivity(body) {
    return this.http.post(baseUrl + "savemasterpostcallactivity", body, {
      headers: new HttpHeaders().set("Content-Type", "application/json"),
    });
  }

  updatemasterpostcallactivity(id, body) {
    return this.http.put(baseUrl + "updatemasterpostcallactivity/" + id, body, {
      headers: new HttpHeaders().set("Content-Type", "application/json"),
    });
  }

  deletemasterpostcallactivity(id) {
    return this.http.delete(baseUrl + "deletemasterpostcallactivity/" + id, {
      headers: new HttpHeaders().set("Content-Type", "application/json"),
    });
  }
}
