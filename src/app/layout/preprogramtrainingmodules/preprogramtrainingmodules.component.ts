...
import {
  PreprogramtrainingService,
  ValidationService,
} from "./preprogramtrainingmodules.service";
...
export class PreprogramTrainingComponent implements OnInit {
  ...
  load_allmodules_list(language) {
    ...
    this.preprogramteachertrainingService
      .getallppttrainingmodules(language)
      .subscribe(
        (data) => {
  ...
  savemodule_btnclick() {
    ...
    if (
      ...
      this.hideLoading_indicator1 = false;
      this.preprogramteachertrainingService
        .findppttrainingmodulebyname(this.modulename_tosave)
        .subscribe(
          (data) => {
            this.hideLoading_indicator1 = true;
  ...
  preflanguage_select_onchange(event) {
    ...
    if (this.selected_preflanguage != "") {
      this.preprogramteachertrainingService
        .getallppttrainingmodules(this.selected_preflanguage)
        .subscribe(
          (data) => {
            if (data) {
              this.allmodules_list = data;
  ...
  updatemodule_btnclick() {
    ...
    if (
      ...
      this.hideLoading_indicator1 = false;
      this.preprogramteachertrainingService
        .findppttrainingmodulebyname(this.modulename_toupdate)
        .subscribe(
          (data) => {
            this.hideLoading_indicator1 = true;
  ...
  load_alltopic_list(submoduleid, language) {
    if (submoduleid != undefined && submoduleid != null && submoduleid != "") {
      ...
      this.preprogramteachertrainingService
        .getallppttrainingtopics(this.selected_submodule_id, language)
        .subscribe(
          (data) => {
  ...
  load_allsubmodules_list(moduleid, language) {
    if (moduleid != undefined && moduleid != null && moduleid != "") {
      ...
      this.preprogramteachertrainingService
        .getallppttrainingsubmodules(moduleid, this.selected_preflanguage)
        .subscribe(
          (data) => {
  ...
  savesubmodule_btnclick() {
    ...
    this.submodulename_tosave = this.submodulename_tosave
      ...
      .toLowerCase();
    if (
      this.selected_submodule_moduleid == undefined ||
      this.selected_submodule_moduleid == null ||
      this.selected_submodule_moduleid == ""
    ) {
      ...
      this.hideLoading_indicator2 = false;
      this.preprogramteachertrainingService
        .findppttrainingsubmodulebyname(
          this.selected_submodule_moduleid,
          this.submodulename_tosave
        )
        .subscribe(
  ...
  savesubtopic_btnclick() {
    ...
    this.subtopicname_tosave = this.subtopicname_tosave
      ...
      .toLowerCase();
    if (
      this.selected_submodule_id == undefined ||
      this.selected_submodule_id == null ||
      this.selected_submodule_id == ""
    ) {
