...
export class PreprogramtrainingService {
	...
	findppttrainingtopicbyname(submoduleid, subtopicname){
		return this.http.get(baseUrl+'ppt_gettopicsbytopicname/'+
	...
	createnewppttrainingtopic(modulebody){
		return this.http.post(baseUrl+'ppt_createtopic',
		modulebody,{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			,responseType: 'text' 
		});
	...
	updateppttrainingtopicbyid(id,modulebody){
		return this.http.put(baseUrl+'ppt_updatetopic/'+id,
		modulebody,{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			,responseType: 'text' 
		});
	...
	findppttrainingmodulebyname(modulename){
		return this.http.get(baseUrl+'findppttrainingmodulebyname/'+modulename,
		{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			//responseType: 'text' 
		});	
	...
	createnewppttrainingmodule(modulebody){
		return this.http.post(baseUrl+'ppt_createmodule',
		modulebody,{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			,responseType: 'text' 
		});
	...
	updateppttrainingmodulebyid(id,modulebody){
		return this.http.put(baseUrl+'ppt_updatemodule/'+id,
		modulebody,{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			,responseType: 'text' 
		});
	...
	findppttrainingsubmodulebyname(moduleid, submodulename){
		return this.http.get(baseUrl+'ppt_getsubmodulesbysubmodulename/'+moduleid+'/'+submodulename,
		{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			//responseType: 'text' 
		});	
	...
	createpptnewtrainingsubmodule(modulebody){
		return this.http.post(baseUrl+'ppt_createsubmodule',
		modulebody,{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			,responseType: 'text' 
		});
	...
	updateppttrainingsubmodulebyid(id,modulebody){
		return this.http.put(baseUrl+'ppt_updatesubmodule/'+id,
		modulebody,{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			,responseType: 'text' 
		});
