...
export class Masterteachertraining1Service {
  ...
  getalltrainingtopics(usertype,submoduleid, language) {
    return this.http.get(
      baseUrl + "getalltrainingtopics/" +usertype+"/"+ submoduleid + "/" + language,
      {
  ...
  findtrainingtopicbyname(submoduleid, subtopicname) {
    return this.http.get(
      baseUrl + "findtrainingtopicbyname/" + submoduleid + "/" + subtopicname,
      {
        headers: new HttpHeaders().set("Content-Type", "application/json"),
        responseType: "text",
      }
  ...
  updatetrainingtopicbyid(id, modulebody) {
    return this.http.put(
      baseUrl + "updatetrainingtopicbyid/" + id,
      modulebody,
      {
        headers: new HttpHeaders().set("Content-Type", "application/json"),
        // responseType: "text",
  ...
  // modules part
  getalltrainingmodules(ln,type) {
    return this.http.get(baseUrl + "getalltrainingmodules/" + ln + "/" + type, {
      headers: new HttpHeaders().set("Content-Type", "application/json"),
      //responseType: 'text'
    });
  }
  ...
  updatetrainingmodulebyid(id, modulebody) {
    return this.http.put(
      baseUrl + "updatetrainingmodulebyid/" + id,
      modulebody,
      {
        headers: new HttpHeaders().set("Content-Type", "application/json"),
        // responseType: "text",
  ...
  getalltrainingsubmodules(usertype,moduleid, language) {
    return this.http.get(
      baseUrl + "getalltrainingsubmodules/" +usertype+"/" + moduleid + "/" + language,
      {
        headers: new HttpHeaders().set("Content-Type", "application/json"),
        //responseType: 'text'
      }
  ...
  findtrainingsubmodulebyname(moduleid, submodulename) {
    return this.http.get(
      baseUrl + "findtrainingsubmodulebyname/" + moduleid + "/" + submodulename,
      {
        headers: new HttpHeaders().set("Content-Type", "application/json"),
        //responseType: 'text'
      }
  ...
  updatetrainingsubmodulebyid(id, modulebody) {
    return this.http.put(
      baseUrl + "updatetrainingsubmodulebyid/" + id,
      modulebody,
      {
        headers: new HttpHeaders().set("Content-Type", "application/json"),
        // responseType: "text",
