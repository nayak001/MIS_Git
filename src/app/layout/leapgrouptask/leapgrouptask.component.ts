...
@Component({
  selector: 'app-leapgrouptask',
  templateUrl: './leapgrouptask.component.html',
  styleUrls: ['./leapgrouptask.component.scss'],
  animations: [routerTransition()]
})
export class LeapgrouptaskComponent implements OnInit {
  ...
  constructor(
    ...
    private leapgrouptaskService: LeapgrouptaskService
  ) {
    this.content_value = '';
