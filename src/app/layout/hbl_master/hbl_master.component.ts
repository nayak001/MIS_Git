...
@Component({
    selector: 'app-hbl_master',
    templateUrl: './hbl_master.component.html',
    styleUrls: ['./hbl_master.component.scss'],
    animations: [routerTransition()]
})

export class hblmasterComponenet implements OnInit {
	// video
    ...
    constructor(
		...
		private masterteachertraining2Service: hblMasterService,
