...
export class TchactivityService {
	...
	gettchactivitybyuser(userid, program, subject, month, week){
		return this.http.get(baseUrl+'gettchactivitybyuser/'+userid+'/'+program+'/'+subject+'/'+month+'/'+week,
		{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			//responseType: 'text' 
		});	
