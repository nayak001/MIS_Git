...
export class TchbaselineService {
	...
	getallstudentsbyteacher_program(userid, program){				
		return this.http.get(baseUrl+'getallstudentsbyteacher_program/'+userid+'/'+program,
		{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			//responseType: 'text' 
		});			
	...
	getallleveldetailsbydetailsid(detailsid){				
		return this.http.get(baseUrl+'getallleveldetailsbydetailsid/'+detailsid,
		{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			//responseType: 'text' 
		});			
	...
	updatestudentlevelbyid(id,body){
		return this.http.put(baseUrl+'updatestudentlevelbyid/'+id,
		body,{
			headers: new HttpHeaders().set('Content-Type', 'application/json')
			,responseType: 'text' 
		});
